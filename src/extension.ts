...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "al-object-extension-tracker-alfatest" is now active!');

	// The command has been defined in the package.json file
	// Now provide the implementation of the command with registerCommand
	// The commandId parameter must match the command field in package.json
    /*
	const disposable = vscode.commands.registerCommand('al-object-extension-tracker-alfatest.helloWorld', () => {
    ...
    */
    ...
    let disposable = vscode.commands.registerCommand('al-object-extension-tracker-alfatest.searchObjectExtension', () => {
